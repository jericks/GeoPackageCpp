...
TEST(LinearRingTests, linearring_create_test) {
...
TEST(LinearRingTests, linearring_wkt_test) {
  geopackage::LinearRing ring {{{0,0}, {0, 10}, {10,10}, {10, 0}, {0,0}}};
  ASSERT_EQ("LINEARRING (0 0, 0 10, 10 10, 10 0, 0 0)", ring.wkt());
}

TEST(LinearRingTests, linearring_clone_test) {
  geopackage::LinearRing ring {{{0,0}, {0, 10}, {10,10}, {10, 0}, {0,0}}};
...
TEST(LinearRingTests, linearring_tostlinearring_test) {
