...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_Point_XY) {
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_Point_Srid) {
    geopackage::GeoPackageGeometryWriter writer{};
    geopackage::Point pt {31.19999710971274, -26.466667461352472};
    pt.setSrid("4326");
    std::vector<std::byte> bytes = writer.write(&pt);
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_Point_XYZM) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_LineString) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_Polygon) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_MultiPoint) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_MultiLineString) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_MultiPolygon) {
    geopackage::GeoPackageGeometryWriter writer{};
...
TEST(GeoPackageGeometryReaderTests, GeoPackageGeometryReader_GeometryCollection) {
    geopackage::GeoPackageGeometryWriter writer{};
