...
TEST(FieldTypeTests, field_type_string_to_string_test) {
...
TEST(FieldTypeTests, field_type_integer_to_string_test) {
  std::stringstream str;
...
TEST(FieldTypeTests, field_type_double_to_string_test) {
  std::stringstream str;
...
TEST(FieldTypeTests, field_type_logical_to_string_test) {
  std::stringstream str;
...
TEST(FieldTypeTests, field_type_invalid_to_string_test) {
  std::stringstream str;
  geopackage::FieldType type = geopackage::FieldType::Boolean;
  str << type;
  ASSERT_EQ("Boolean", str.str());
